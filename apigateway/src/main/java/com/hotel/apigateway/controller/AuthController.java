...
import com.hotel.apigateway.entity.AuthResponse;
...
public class AuthController {
    ...
    public ResponseEntity<AuthResponse> login(
        ...
        logger.info(client.getAccessToken().getTokenValue());
        ...
        authResponse.setExpireIn(client.getAccessToken().getExpiresAt().getEpochSecond());
